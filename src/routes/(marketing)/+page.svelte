<script lang="ts">
	...
	import { Badge, Button, Card, Landing, SectionHeading } from '@tabeladev/tabelawebui';

	let { data } = $props<{ data: PageData }>();

	const TITLE = 'TabelaHub — o hub da TabelaDev';
	const DESCRIPTION =
	...
	const HERO_NOTE = 'Tudo open source (AGPL-3.0), construído em cima do tabelawebui.';
...
{#snippet heroTitle()}
	Tabela<span style="color: var(--twui-accent);">Hub</span>
{/snippet}
...
<div class="relative flex w-full flex-1 flex-col">
	...
	<div class="flex w-full flex-col gap-24 px-6 pt-16 pb-8 md:pt-24">
		...
		<section id="projetos" class="flex scroll-mt-20 flex-col gap-8">
			<SectionHeading
				eyebrow="Produtos"
